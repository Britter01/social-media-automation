...
def _system_prompt(brand_name: str, founder: str, tagline: str, voice: str) -> str:
    ...
    return (
        ...
        "jargon. One idea per post. No hype, no filler, and never use emojis — "
        "anywhere. They are stripped before publishing, so any you write only "
        "leave gaps. Sound like a knowledgeable friend, not a brand "
        "account.\n\n"
